...
//    v0 = 1
//  )
  val obstacles = Set((1,0), (1,1), (3,1), (4, 2), (7,8), (6,5), (9,2), (8,5))
  val rl: QMatrix.Facade = Facade(
    width = 10,
    height = 6,
    initial = (0, 0),
    terminal = {case (9,5) => true; case _ => false},
    reward = {case (x, _) if obstacles.contains(x) => -100; case _ => -1},
  ...
  val q0 = rl.qFunction
  println(rl.show(q0.vFunction,"%2.1f", obstacles))
